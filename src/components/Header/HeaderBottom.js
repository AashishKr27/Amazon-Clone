      ...
      {sidebar && (
        <div className="w-full h-screen text-black fixed top-0 left-0 bg-amazon_blue bg-opacity-50">
          <div className="w-full h-full relative">
            <motion.div ref={ref} initial={{x:-500, opacity:0}} animate={{x:0, opacity:1}} transition={{duration:.5}} className="md:w-[350px] w-[80%] h-full bg-white border border-black">
              ...
              <SideNavContent
                ...
                three="Contact Us"
              />
            <span onClick={()=>setSidebar(false)} className="cursor-pointer absolute top-0 md:left-[360px] left-[82%] w-10 h-10 text-black flex items-center justify-center border bg-gray-200 hover:bg-red-600 hover:text-white duration-300"><Close/></span>
            </motion.div>
          </div>
        </div>
      )}
